...
void ToBit(Type* MasType, int size_MasType, bool *MasBit)
{
    int size_byte=8;
...
template <typename Type>
void ToType(bool* MasBit, Type* MasType, int size_MasType)
{
    int size_byte=8;
    int type_size=sizeof(Type)*size_byte;
    int sm=0;
...
void SetNormirMas(bool *MasNormirBit, int size_MasNormirBit,
                  bool* MasTextBit, unsigned char kolvo_normir_bit)
{
    ...
    ToBit(buf, size_buf, MasChislaNormirBit);
